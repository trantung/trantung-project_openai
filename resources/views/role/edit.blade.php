                                    ...
                                    <div class="tab-content mt-3">
                                        <div class="tab-pane active" id="tab_info" role="tabpanel">
                                            <div class="tab-pane-content">
                                                <form action="{{ route('role.update', ['id' => $role->id]) }}" id="form_role_info" method="post">
                                                    @csrf
                                                    <div class="mb-2 row">
                                                        <div class="col-2">
                                                        ...
                                                        <div class="col-5">
                                                            <input type="text" name="name" value="{{ $role->name }}" class="js-required form-control" placeholder="Nhập tên" required="">
                                                        </div>
                                                    </div>
                                                    <div class="mb-2 row">
                                                        <div class="col-2">
                                                        ...
                                                        <div class="col-5">
                                                            <textarea id="description" class="form-control" name="description" placeholder="Nhập mô tả" rows="5">{{ $role->description }}</textarea>
                                                        </div>
                                                    </div>
