                                    ...
                                    <div class="tab-content mt-3">
                                        <div class="tab-pane active" id="tab_info" role="tabpanel">
                                            <div class="tab-pane-content">
                                                <form action="{{ route('permission.update', ['id' => $permission->id]) }}" id="form_permission_info" method="post">
                                                    @csrf
                                                    <div class="mb-2 row">
                                                        <div class="col-2">
                                                        ...
                                                        <div class="col-5">
                                                            <input type="text" name="permission_name" class="form-control" value="{{ $permission->name }}" class="js-required" required="">
                                                        </div>
                                                    </div>
                                                    <div class="mb-2 row">
                                                        <div class="col-2">
                                                        ...
                                                        <div class="col-5">
                                                            <input type="text" name="permission_route_name" class="form-control" value="{{ $permission->route_name }}" class="js-required" required="">
                                                        </div>
                                                    </div>
                                                    <div class="mb-2 row">
                                                        <div class="col-2">
                                                        ...
                                                        <div class="col-5">
                                                            <input type="text" name="permission_action" class="form-control" value="{{ $permission->action }}" class="js-required" required="">
                                                        </div>
                                                    </div>
                                                    <div class="mb-2 row">
                                                        <div class="col-2">
                                                        ...
                                                        <div class="col-5">
                                                            <input type="text" name="permission_method" class="form-control" value="{{ $permission->method }}" class="js-required" required="">
                                                        </div>
                                                    </div>
                                                    <div class="mb-2 row">
                                                        <div class="col-2">
                                                        ...
                                                        <div class="col-5">
                                                            <textarea id="permission_description" class="form-control" name="permission_description" placeholder="Nhập mô tả" rows="5">{{ $permission->description }}</textarea>
                                                        </div>
                                                    </div>
                                                    <div class="mb-2 row">
                                                        <div class="col-2">
