<div class="tab-pane-content">
    <div class="container course-class-student">
        <div class="row-search-add">
            <select id="filter-teacher-name" name="class" style="width: 30%;" class="select2-hidden-accessible" aria-hidden="true">
        ...
        <div class="row-total-add my-2">
            <div class="box-total-item">Tổng số GV: <span id="total_teacher">0</span></div>
        </div>
        <div class="wrapper-table-scroll">
            <table class="table-scroll table-course-class-teacher">
                ...
                <tbody>
                    <tr>
                        <th style="text-align: center" colspan="6">Không có giáo viên</th>
                    </tr>
                </tbody>
            </table>
        </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row-search-create">
                        <div class="mb-4 box-search">
                            <select id="search-teacher-other" name="class" style="width: 200%;" class="select2-hidden-accessible" aria-hidden="true">
                                <option value="" disabled selected>Nhập tên giáo viên</option>
                            </select>
                        </div>
