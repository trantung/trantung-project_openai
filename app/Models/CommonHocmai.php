...
class CommonHocmai extends Model
{
    ...
    public static function hocmaiTask1VocabularyGramma($jsonData)
    {
    ...
    public static function hocmaiRuleTask1TaskAchiement()
    {
    ...
    public static function hocmaiTask1BandTaskAchiement($jsonData)
    {
        ...
        $rule = self::hocmaiRuleTask1TaskAchiement();
    ...
    public static function hocmaiRuleTask1CoherenceCohesion()
    {
    ...
    public static function hocmaiTask1BandCoherenceCohesion($jsonData)
    {
        ...
        $rule = self::hocmaiRuleTask1CoherenceCohesion();
        $sample = $jsonData['sample'];
        $report = $jsonData['report'];
    ...
    public static function hocmaiRuleTask1LexicalResource()
    {
    ...
    public static function hocmaiTask1BandLexicalResource($jsonData)
    {
        $yourApiKey = getenv('OPENAI_HOCMAI_KEY');
        $client = OpenAI::client($yourApiKey);
        $model = getenv('OPENAI_API_MODEL');
        $systeMessage = self::hocmaiSystemPromptLexicalResource();
        $rule = self::hocmaiRuleTask1LexicalResource();
        $sample = $jsonData['sample'];
        $report = $jsonData['report'];
    ...
    public static function hocmaiRuleTask1GrammaRange()
    {
    ...
    public static function hocmaiTask1BandGrammaRange($jsonData)
    {
        ...
        $rule = self::hocmaiRuleTask1GrammaRange();
        $sample = $jsonData['sample'];
        $report = $jsonData['report'];
