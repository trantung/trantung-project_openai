...
class Part6Job implements ShouldQueue
{
    ...
    {
        try {
            $chat = CommonHocmaiTask2::hocmaiImprovedEssay($this->jsonData);
            ...
            if (!empty($checkData)) {
                ...
                CommonHocmaiTask2::callCms($dataResponseChat, $this->apiUserQuestionId, CommonHocmaiTask2::IMPROVE_ESSAY);
