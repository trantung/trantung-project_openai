...
class Part4Job implements ShouldQueue
{
    ...
    {
        try {
            $chat = CommonHocmaiTask2::hocmaiBandLexicalResource($this->jsonData);
            ...
            if (!empty($checkData)) {
                ...
                CommonHocmaiTask2::callCms($dataResponseChat, $this->apiUserQuestionId, CommonHocmaiTask2::LEXICAL_RESOURCE);
