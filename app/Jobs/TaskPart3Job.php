...
class TaskPart3Job implements ShouldQueue
{
    ...
    {
        try {
            $chat = CommonHocmai::hocmaiBandCoherenceCohesion($this->jsonData);
            ...
            if (!empty($checkData)) {
                ...
                CommonHocmai::callCmsTask1($dataResponseChat, $this->apiUserQuestionId, CommonHocmai::COHERENCE_COHESION_TASK_1);
