...
class Task1Job implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        dispatch(new TaskPart6Job($this->jsonData, 6, $this->apiUserQuestionId, $this->writing_task_number));
        dispatch(new TaskPart7Job($this->jsonData, 7, $this->apiUserQuestionId, $this->writing_task_number));
        dispatch(new TaskPart8Job($this->jsonData, 8, $this->apiUserQuestionId, $this->writing_task_number));
    }
