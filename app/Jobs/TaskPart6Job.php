...
class TaskPart6Job implements ShouldQueue
{
    ...
    {
        try {
            $chat = Common::task1BandLexicalResource($this->jsonData);
            ...
            if (!empty($checkData)) {
                ...
                Common::callCmsTask1($dataResponseChat, $this->apiUserQuestionId, Common::PART_NUMBER_LEXICAL_RESPONSE);
