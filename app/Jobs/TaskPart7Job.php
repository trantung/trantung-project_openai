...
class TaskPart7Job implements ShouldQueue
{
    ...
    {
        try {
            $chat = Common::task1BandGramma($this->jsonData);
            ...
            if (!empty($checkData)) {
                ...
                Common::callCmsTask1($dataResponseChat, $this->apiUserQuestionId, Common::PART_NUMBER_GRAMMA_RESPONSE);
