...
class Part3Job implements ShouldQueue
{
    ...
    {
        try {
            $chat = CommonHocmaiTask2::hocmaiBandCoherenceCohesion($this->jsonData);
            ...
            if (!empty($checkData)) {
                ...
                CommonHocmaiTask2::callCms($dataResponseChat, $this->apiUserQuestionId, CommonHocmaiTask2::COHERENCE_COHESION);
