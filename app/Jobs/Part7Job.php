...
class Part7Job implements ShouldQueue
{
    ...
    {
        try {
            $chat = Common::responseGramma($this->jsonData);
            ...
            if (!empty($checkData)) {
                ...
                Common::callCms($dataResponseChat, $this->apiUserQuestionId, Common::PART_NUMBER_GRAMMA_RESPONSE);
