...
class TaskPart4Job implements ShouldQueue
{
    ...
    {
        try {
            $chat = CommonHocmai::hocmaiBandLexicalResource($this->jsonData);
            ...
            if (!empty($checkData)) {
                ...
                CommonHocmai::callCmsTask1($dataResponseChat, $this->apiUserQuestionId, CommonHocmai::LEXICAL_RESOURCE_TASK_1);
